...
export const ColorPaletteModal = ({ navigation }) => {
  ...
  return (
    <View style={[styles.container_All, { height: '100%' }]}>
      <TextInput
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <ColorSelector
            ...
            onValueChange={(value) => handleColorSelect(item, value)}
          />
        )}
      />
      <Pressable
        ...
        style={({ pressed }) => [
          {
            backgroundColor: pressed ? 'rgb(210, 230, 255)' : '#63adfc',
          },
          ,
          { padding: 15, margin: 10, borderRadius: 20 },
        ]}>
...
const styles = StyleSheet.create({
  ...
  textView: { width: '100%', alignItems: 'center', flex: 1, justifyContent: 'center' },
});
